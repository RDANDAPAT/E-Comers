...
?>
    ...
    <script src="<?php echo base_url('assets/admin-assets/vendors/progressbar.js/progressbar.min.js');?>"></script>
    <script src="<?php echo base_url('assets/admin-assets/vendors/jvectormap/jquery-jvectormap.min.js');?>"></script>
    <script src="<?php echo base_url('assets/admin-assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js');?>"></script>
    <script src="<?php echo base_url('assets/admin-assets/vendors/owl-carousel-2/owl.carousel.min.js');?>"></script>
    ...
    <script src="<?php echo base_url('assets/admin-assets/js/settings.js');?>"></script>
